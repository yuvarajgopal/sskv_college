      ...
      <section className="section-padding bg-white">
        <div className="container-custom mx-auto max-w-4xl">
          ...
          <AnimatedSection>
            ...
            <p className="text-sm text-neutral-700 mb-3">The college regularly conducts the following to educate students and staff about gender sensitivity and prevention of sexual harassment:</p>
            <div className="flex flex-wrap gap-3 mb-8">
              {awarenessActivities.map((act, i) => (
                <span key={i} className="px-4 py-2 bg-primary-50 border border-primary-100 text-primary-800 text-sm font-medium rounded-full">
                  {act}
                </span>
              ))}
            </div>
          ...
          <AnimatedSection>
            ...
            <div className="bg-neutral-50 border border-neutral-200 rounded-2xl p-5 mb-8">
              ...
              <p className="text-xs text-neutral-500 mt-3 italic">(Available upon request or as per institutional policy)</p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-6 text-white flex items-start gap-5">
              ...
              <div>
                <p className="text-accent-400 text-xs font-bold uppercase tracking-wide mb-0.5">Committee</p>
                <h3 className="text-base font-bold font-heading">Internal Complaints Committee (ICC)</h3>
                <p className="text-white/70 text-xs mt-1 leading-relaxed">
                  Constituted under the Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013
                </p>
                <Link
                  to="/administration/icc"
