...
function FacultyPhoto({ src, name, size = 'md' }) {
  ...
  return <div className={`${sizeClass} rounded-full bg-teal-100 flex items-center justify-center flex-shrink-0`}><FaUserTie className="text-teal-400" /></div>;
}
  ...
  return (
    <>
      ...
      <section className="section-padding bg-teal-50">
        <div className="container-custom mx-auto">
          <SectionHeading title="Program Outcomes" subtitle="What students gain from the BCA (Shift II) program" />
      ...
      <section className="section-padding bg-white">
        <div className="container-custom mx-auto">
          <SectionHeading title="Our Faculty" subtitle="Dedicated educators for the Shift II programme" />
              ...
              <div className="max-w-lg mx-auto mb-10">
                <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-6 flex items-center gap-5 text-white">
                  ...
                  <div className="flex-1">
                    ...
                    <a href={f.resume} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 bg-teal-500/20 hover:bg-teal-500/30 text-teal-300 text-xs font-semibold rounded-lg transition-colors">
              ...
              {faculty.filter((f) => !f.isHod).map((f, i) => (
                <AnimatedSection key={f.name} delay={i * 0.05}>
                  <div className="bg-neutral-50 hover:bg-teal-50 transition-colors duration-300 rounded-xl p-5 border border-neutral-100 flex flex-col gap-4">
                    ...
                    <a href={f.resume} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-1.5 w-full py-1.5 bg-teal-50 hover:bg-teal-100 text-teal-700 text-xs font-semibold rounded-lg border border-teal-100 transition-colors">
                      <FaFilePdf className="text-xs" /> View Resume
                    </a>
                  </div>
                </AnimatedSection>
      ...
      <CTABanner title="Interested in BCA (Shift II)?" subtitle="Apply now for the evening programme and begin your journey into IT." />
    </>
  );
}
