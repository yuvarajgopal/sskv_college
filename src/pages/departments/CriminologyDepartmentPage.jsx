...
import { FaGavel, FaUserTie, FaGraduationCap, FaUsers, FaAward, FaFilePdf, FaCamera } from 'react-icons/fa';
...
const activityPhotos = [
  { src: '/images/activities/criminology/1.jpg', caption: 'Seminar on Criminal Law' },
  { src: '/images/activities/criminology/2.jpg', caption: 'Forensic Science Workshop' },
  { src: '/images/activities/criminology/3.jpg', caption: 'Guest Lecture' },
  { src: '/images/activities/criminology/4.jpg', caption: 'Court Visit' },
  { src: '/images/activities/criminology/5.jpg', caption: 'Mock Trial' },
  { src: '/images/activities/criminology/6.jpg', caption: 'Cybercrime Awareness' },
  { src: '/images/activities/criminology/7.jpg', caption: 'Case Study Discussion' },
  { src: '/images/activities/criminology/8.jpg', caption: 'Department Day' },
];
...
export default function CriminologyDepartmentPage() {
  ...
  return (
    <>
      ...
      {/* ─── Faculty ─── */}
      <section id="faculty" className="section-padding bg-rose-50">
        <div className="container-custom mx-auto">
          <SectionHeading
            title="Faculty"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {faculty.filter((f) => !f.isHod).map((f, i) => (
                <AnimatedSection key={f.name} delay={i * 0.05}>
                  <div className="bg-white hover:bg-rose-50 transition-colors duration-300 rounded-xl p-5 border border-neutral-100 flex flex-col gap-4">
          ...
          <AnimatedSection delay={0.3}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12 max-w-3xl mx-auto">
              {[
                ...
                <div key={stat.label} className="bg-white rounded-xl p-5 text-center border border-rose-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
            {outcomes.map((outcome, i) => (
              <AnimatedSection key={i} delay={i * 0.07}>
                <div className="flex items-start gap-3 bg-rose-50 rounded-xl p-5 border border-rose-100 shadow-sm h-full">
      ...
      <section id="activities" className="section-padding bg-rose-50">
        <div className="container-custom mx-auto">
          <SectionHeading
            title="Department Activities"
            subtitle="Seminars, workshops, and events that build practical skills"
          />

          <AnimatedSection>
            <p className="text-neutral-600 leading-relaxed max-w-3xl mx-auto text-center mb-10">
              The Department of Criminology at SSKV College organizes seminars on criminal law, forensic science workshops, guest lectures by legal experts and law enforcement professionals, and field visits to courts and correctional institutions. Students engage in mock trials, case study discussions, and awareness campaigns on cybercrime and social justice.
            </p>
          </AnimatedSection>
