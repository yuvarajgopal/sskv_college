...
import { FaLanguage, FaUserTie, FaGraduationCap, FaUsers, FaAward, FaFilePdf, FaCamera } from 'react-icons/fa';
    ...
    <>
      ...
      <section id="faculty" className="section-padding bg-blue-50">
        <div className="container-custom mx-auto">
          <SectionHeading
            title="Faculty"
            subtitle="15 dedicated educators committed to academic and communicative excellence"
          />
              ...
              <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-8 text-white mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                    ...
                    <div className="flex justify-between items-center py-2 border-b border-white/10 last:border-0">
                      ...
                      <span className="text-white font-semibold text-sm text-right ml-4">English Language & Literature</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10 last:border-0">
                    ...
                    <div className="flex justify-between items-center py-2 border-b border-white/10 last:border-0">
                      ...
                      <span className="text-white font-semibold text-sm text-right ml-4">B.A. English from a recognized university</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10 last:border-0">
      ...
      <section id="activities" className="section-padding bg-blue-50">
        <div className="container-custom mx-auto">
          <SectionHeading title="Department Activities" subtitle="Enriching language skills and literary appreciation" />
          <AnimatedSection>
            <p className="text-neutral-600 leading-relaxed mb-6 max-w-4xl mx-auto">
              The Department of English at SSKV College of Arts and Science for Women is committed to developing students' language proficiency, communication skills, and literary understanding. The department organizes seminars, workshops, guest lectures, and literary activities such as debates, elocution, essay writing, and drama to enrich academic learning. Through English Club activities and interactive sessions, students are encouraged to improve their confidence and creativity. The department also motivates students to participate in intercollegiate competitions and skill-development programs for overall personality development.
            </p>
          </AnimatedSection>
          <div className="max-w-4xl mx-auto">
            <ActivityGallery images={[
              { src: '/images/activities/english/1.jpg', caption: 'Literary Association Inauguration' },
              { src: '/images/activities/english/2.jpg', caption: 'Poetry Recitation Competition' },
              { src: '/images/activities/english/3.jpg', caption: 'Guest Lecture on Communication Skills' },
              { src: '/images/activities/english/4.jpg', caption: 'Debate Competition' },
              { src: '/images/activities/english/5.jpg', caption: 'Drama Performance' },
              { src: '/images/activities/english/6.jpg', caption: 'Essay Writing Competition' },
              { src: '/images/activities/english/7.jpg', caption: 'Intercollegiate Literary Fest' },
              { src: '/images/activities/english/8.jpg', caption: 'English Club Activities' },
            ]} color="blue" />
          </div>
        </div>
      </section>
